...
const DoctorsList = () => {
    ...
    const filteredDoctors = doctors.filter(doctor => {
        ...
        const matchesSpecialty = specialtyFilter ? 
            specialty.toLowerCase() === specialtyFilter.toLowerCase() : true;
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-gradient-to-r from-cyan-700 to-blue-900 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 py-12">
                    <h1 className="text-4xl font-bold text-white text-center mb-4">Find Your Doctor</h1>
                    <p className="text-cyan-100 dark:text-gray-300 text-center mb-8 max-w-2xl mx-auto">
                        Browse our network of qualified medical professionals to find the right doctor for your needs.
                    </p>
                        ...
                        >
                            <div className="flex flex-col md:flex-row">
                                ...
                                <div className="md:w-64 bg-cyan-50 dark:bg-gray-700 p-6 flex flex-col items-center justify-center">
                                    ...
                                    <p className="text-cyan-600 dark:text-cyan-400 font-medium text-center">{doctor.specialty || 'Specialist'}</p>
                                ...
                                <div className="flex-1 p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Hospital</h4>
                                            <p className="text-gray-900 dark:text-white">{doctor.hospital || 'N/A'}</p>
                                        </div>
                                        
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Languages</h4>
                                            <p className="text-gray-900 dark:text-white">{doctor.languages || 'N/A'}</p>
                                        </div>
                                        
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Gender</h4>
                                            <p className="text-gray-900 dark:text-white">{doctor.gender || 'N/A'}</p>
                                        </div>
                                        
                                        <div>
                                            <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Experience</h4>
                                            <p className="text-gray-900 dark:text-white">{doctor.experience || 'N/A'}</p>
                                        </div>
                                    </div>

                                    <div className="mt-4">
                                        <h4 className="text-sm font-medium text-gray-500 dark:text-gray-400">Availability</h4>
                                        <p className="text-gray-900 dark:text-white">{doctor.availability || 'N/A'}</p>
                                    </div>
