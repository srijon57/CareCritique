...
const CardiologistsList = () => {
    ...
    useEffect(() => {
        ...
        fetchCardiologistsAndReviews();
    }, [location.search]);

    const fetchCardiologistsAndReviews = async () => {
        setLoading(true);
        try {
            ...
            if (Array.isArray(doctorsResponse.data)) {
                // Filter cardiologists
                const cardiologistList = doctorsResponse.data
                    .filter(doctor => 
                        doctor.Specialty.toLowerCase() === "cardiologist"
                    )
                    .map(doctor => ({
                        id: doctor.DoctorID,
                ...
                // Fetch reviews for each cardiologist
                const updatedCardiologists = await Promise.all(
    ...
    const handleApplyFilters = () => {
        ...
        navigate(`/cardiologists?${params.toString()}`);
    };
            ...
            <div className="bg-gradient-to-r from-cyan-700 to-blue-900 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 py-12">
                    ...
                    <p className="text-cyan-100 dark:text-gray-300 text-center mb-8 max-w-2xl mx-auto">
                        Connect with experienced heart specialists dedicated to your cardiovascular health.
                    </p>
                            ...
                            <div className="col-span-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        id="search"
                                        type="text"
                                        placeholder="Search cardiologists by name"
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">
                        {loading
                            ? "Loading cardiologists..."
                            : filteredCardiologists.length === 0
                            ? "No cardiologists found"
                            : `Showing ${filteredCardiologists.length} specialist${filteredCardiologists.length === 1 ? "" : "s"}`}
                    </h2>
                </div>
                ...
                {!loading && !error && filteredCardiologists.length === 0 && (
