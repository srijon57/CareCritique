...
const NeurologistsList = () => {
    ...
    useEffect(() => {
        ...
        fetchNeurologistsAndReviews();
    }, [location.search]);

    const fetchNeurologistsAndReviews = async () => {
        setLoading(true);
        try {
            ...
            if (Array.isArray(doctorsResponse.data)) {
                const neurologistList = doctorsResponse.data
                    .filter(doctor => 
                        doctor.Specialty.toLowerCase() === "neurologist"
                    )
                    .map(doctor => ({
                        id: doctor.DoctorID,
                ...
                const updatedNeurologists = await Promise.all(
                    neurologistList.map(async (doctor) => {
                        try {
                ...
                setError("Failed to fetch neurologists. Please try again later.");
            }
        } catch (error) {
            console.error(
                "Error fetching neurologists:",
    ...
    const handleApplyFilters = () => {
        ...
        navigate(`/neurologists?${params.toString()}`);
    };
    ...
    const clearFilters = () => {
        setSearchQuery("");
        navigate("/neurologists");
    };

    const filteredNeurologists = neurologists.filter(doctor => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-gradient-to-r from-cyan-700 to-blue-900 dark:from-gray-800 dark:to-gray-900">
                <div className="container mx-auto px-4 py-12">
                    ...
                    <p className="text-cyan-100 dark:text-gray-300 text-center mb-8 max-w-2xl mx-auto">
                        Find experienced neurologists dedicated to treating disorders of the nervous system.
                    </p>
                            ...
                            <div className="col-span-1">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        id="search"
                                        type="text"
                                        placeholder="Search neurologists by name"
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold text-gray-800 dark:text-white">
                        {loading
                            ...
                            ? "No neurologists found"
                            : `Showing ${filteredNeurologists.length} specialist${filteredNeurologists.length === 1 ? "" : "s"}`}
                    </h2>
                </div>
                ...
                {!loading && !error && filteredNeurologists.length === 0 && (
                ...
                <div className="space-y-6">
                    {filteredNeurologists.map(doctor => (
                        <div
                            key={doctor.id}
...
export default NeurologistsList;