...
const DoctorDetails = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const average = fetchedReviews.length
                ...
                if (isAuthenticated && accessToken) {
                    const profileResponse = await axios.get(
                        `${import.meta.env.VITE_BACKEND}/api/profile`,
                        {
    ...
    const handleToggleVerification = async () => {
        ...
        try {
            ...
            setError(
                error.response?.data?.error || "Failed to toggle verification."
            );
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50 dark:from-gray-900 dark:to-gray-950 text-slate-900 dark:text-slate-100 p-4 md:p-6 overflow-x-hidden">
            {/* Background Decorative Elements */}
            <div className="absolute top-0 left-0 w-64 h-64 bg-cyan-200/10 dark:bg-cyan-800/5 rounded-full blur-3xl -z-10"></div>
            <div className="absolute bottom-0 right-0 w-64 h-64 bg-gold-200/10 dark:bg-gold-800/5 rounded-full blur-3xl -z-10"></div>
                ...
                >
                    ...
                    <div className="h-48 bg-gradient-to-r from-navy-800 via-cyan-700 to-blue-700 relative overflow-hidden">
                        ...
                        <div className="absolute top-4 right-4 flex items-center gap-2 text-white">
                            <span className="px-3 py-1 bg-gold-500/80 text-white text-xs font-bold rounded-full"></span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div className="bg-white dark:bg-gray-700 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-600">
                                    ...
                                    <div className="space-y-4">
                                        <Info
                                            ...
                                            icon={
                                                <MdLocationOn className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                        <Info
                                            label="📍 Address"
                                        ...
                                        <Info
                                            ...
                                            icon={
                                                <MdPhone className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                        <Info
                                            label="👤 Gender"
                                            value={doctor.Gender}
                                            icon={
                                                <MdWork className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="bg-white dark:bg-gray-700 rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-gray-600">
                                    ...
                                    <div className="space-y-4">
                                        <Info
                                            ...
                                            icon={
                                                <MdSchool className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                        <Info
                                            label="⏳ Experience"
                                        ...
                                        <Info
                                            ...
                                            icon={
                                                <MdLanguage className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                        <Info
                                            label="📆 Availability"
                                            ...
                                            icon={
                                                <MdCalendarToday className="h-5 w-5 text-gray-500 dark:text-gray-400" />
                                            }
                                        />
                                    </div>
                                </div>
                                        ...
                                        <p className="text-slate-700 dark:text-slate-300 leading-relaxed text-base">
                                            {doctor.Biography || (
                                                <em className="text-gray-500 dark:text-gray-400">
                                                    No biography available. This
                                                    doctor has not yet shared
...
const Info = ({ label, value, icon }) => (
    <p className="flex items-start">
        {icon && (
            <span className="mt-0.5 mr-3 text-gray-500 dark:text-gray-400">
                {icon}
            </span>
        )}
