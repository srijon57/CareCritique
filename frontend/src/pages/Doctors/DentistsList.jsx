            ...
            .then(response => {
                if (Array.isArray(response.data)) {
                    const filteredDoctors = response.data
                        .filter(doctor => doctor.Specialty.toLowerCase() === "dentist")
                        .map(doctor => ({
                            id: doctor.DoctorID,
    ...
    return (
        <div className="min-h-screen bg-gray-200 dark:bg-gray-900 text-black dark:text-white">
            <div className="container mx-auto p-6">
                <h2 className="text-4xl font-bold mb-8 text-cyan-800 text-center dark:text-white">Dentists</h2>
                ...
                {filteredDentists.length === 0 ? (
                    <p className="text-center text-gray-500 dark:text-gray-400">No dentists found.</p>
                ) : (
