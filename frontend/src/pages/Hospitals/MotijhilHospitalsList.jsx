        ...
        try {
            ...
            if (Array.isArray(response.data)) {
                const filteredHospitals = response.data.filter(hospital => 
                    hospital.HospitalArea?.toLowerCase() === "motijhil"
                );
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
            ...
            <div className="bg-cyan-700 dark:bg-gray-800 text-white py-12">
                <div className="container mx-auto px-4">
                    <h1 className="text-4xl font-bold mb-4">Hospitals in Motijhil</h1>
                    <p className="text-cyan-100 dark:text-gray-300 max-w-2xl">
                        Find quality healthcare facilities in the Motijhil area
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                {!loading && hospitals.length === 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 text-center">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 mb-4">There are currently no hospitals registered in Motijhil</p>
                    </div>
                )}
